...
namespace TestCaseAnalyzer.App
{
    ...
    public class Checker
    {
        ...
        internal HashSet<int> FindDeletedRequirements()
        {
            var deletedRequiremens = new HashSet<int>();
        ...
        internal HashSet<int> FindUnusedRequirments()
        {
            var usedRequirement = this.FindUsedRequirments();
            var unusedRequirement = new HashSet<int>();
        ...
        internal HashSet<int> FindUsedRequirments()
        {

            var usedRequirement = new HashSet<int>();
            foreach (var requirement in Requirements)
            {
