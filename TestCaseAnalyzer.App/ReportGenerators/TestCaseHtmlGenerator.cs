...
namespace TestCaseAnalyzer.App
{
    public class TestCaseHtmlGenerator
    {
        ...
        private static string GenerateEpicsHtml(TestCaseOnlyExecutedItem testCase)
        {
            string epicHtml = "<ul>";
        ...
        private static string GenerateRequirementsHtml(List<Requirement> requirements, TestCaseOnlyExecutedItem testCase)
        {
